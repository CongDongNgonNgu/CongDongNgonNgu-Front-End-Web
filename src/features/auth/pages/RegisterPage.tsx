...
export function RegisterPage() {
  ...
  return (
    <AuthBody
      ...
      editorialPrompt={<p>Đã có tài khoản? <Link className={styles.textLink} to='/login'>Đăng nhập ngay →</Link></p>}
    ...
    >
      <form ref={formRef} className={styles.authForm} onSubmit={submit} noValidate aria-describedby={error ? 'register-error' : undefined}>
        ...
        <label className={styles.authConsent}>
          ...
          <span>Tôi đã đọc và đồng ý với <a className={styles.textLink} href='#rules'>Quy tắc cộng đồng</a> và <a className={styles.textLink} href='#privacy'>Chính sách bảo mật</a> của CongDongNgonNgu.vn.</span>
        </label>
        ...
        <div className={styles.authLinks}>
          ...
          <Link className={styles.textLink} to='/login'>Đăng nhập ngay</Link>
        </div>
      </form>
    </AuthBody>
  );
